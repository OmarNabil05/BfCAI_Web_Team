  ...
  <div class="hidden md:flex gap-6 items-center text-white font-bold text-[16px]">
    <?php if ($isLoggedIn): ?>
      ...
      <a href="cart.php" class="relative hover:text-[#fac564] transition">
        ...
        <?php if ($cart_count > 0): ?>
          <span class="absolute -top-2 -right-3 bg-red-500 text-white text-xs px-2 rounded-full"><?= $cart_count ?></span>
        <?php endif; ?>
      </a>

      <!-- Profile -->
      <a href="profile.php" class="hover:text-[#fac564] transition">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" class="w-6 h-6">
      ...
      <a href="menu.php?logout=true" class="hover:text-[#fac564] transition">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
          <path stroke-linecap="round" stroke-linejoin="round" d="M15 12H3m0 0l4-4m-4 4l4 4m6 4h6a2 2 0 002-2V6a2 2 0 00-2-2h-6"/>
        </svg>
      </a>

    <?php else: ?>
      <a href="../auth/login.php" class="hover:text-[#fac564]">Login</a>
      <a href="../auth/register.php" class="py-2 px-6 rounded-full bg-[#fac564] text-black font-bold">Sign Up</a>
    <?php endif; ?>
  </div>
...
<!-- Mobile Menu -->
<div id="mobileMenu" class="fixed top-0 right-[-100%] w-[50%] h-full bg-[#0b0d10] flex flex-col p-6 gap-6 transition-all duration-300 z-50">
  <button id="closeBtn" class="text-white text-2xl self-end">✕</button>

  <a href="menu.php" class="text-white font-bold text-lg hover:text-[#fac564]">Home</a>
  ...
  <div class="mt-6 flex flex-col gap-4">
    <?php if ($isLoggedIn): ?>
      ...
      <a href="menu.php?logout=true" class="flex items-center gap-2 text-white hover:text-[#fac564]">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
          <path stroke-linecap="round" stroke-linejoin="round" d="M15 12H3m0 0l4-4m-4 4l4 4m6 4h6a2 2 0 002-2V6a2 2 0 00-2-2h-6"/>
        </svg>
      </a>
    ...
    <?php else: ?>
      ...
      <a href="../auth/register.php" class="py-2 rounded-full bg-[#fac564] text-black font-bold text-center">Sign Up</a>
    <?php endif; ?>
  </div>
</div>
